...
August presenterar den tillagda regeln \§4.4.6. ``Samtalsklimat''. Se bilaga 5
...
\begin{beslut}
  ...
  \begin{itemize}
    \item[Namn: ] August Eriksson %I wonder if we actually need the ID number
      %people who aren't part of the board
    \item[Personnummer: ] \qquad \qquad \qquad \qquad -- \qquad \qquad
  \end{itemize}
  \begin{itemize}
