...
LUDDs nya LED-skylt är nu uppsatt. Nuvarande nätaggregat och LED-slinga som används ger inte önskad "fade"-effekt på skylten, varefter en bättre lösning eftertraktas. %Som jag förstod det skulle LED-skylten ha ett API för att medlemmar skulle kunna ändra färg, eller nåt, också.
